(function(factory){if(typeof module==="object"&&module.exports){module.exports=factory}else{factory(Highcharts)}})(function(Highcharts){var protocol=window.location.protocol;
	var defaultOptionsZhCn={
		lang:{
			contextButtonTitle:"鍥捐〃瀵煎嚭鑿滃崟",
			decimalPoint:".",
			downloadJPEG:"涓嬭浇 JPEG 鍥剧墖",
			downloadPDF:"涓嬭浇 PDF 鏂囦欢",
			downloadPNG:"涓嬭浇 PNG 鏂囦欢",
			downloadSVG:"涓嬭浇 SVG 鏂囦欢",
			downloadXLS:"涓嬭浇 XLS 鏂囦欢",
			openInCloud:"鍦� Highcharts Cloud 涓墦寮€",
			...
			thousandsSep:",",
			weekdays:["鏄熸湡澶�","鏄熸湡涓€","鏄熸湡浜�","鏄熸湡涓�","鏄熸湡鍥�","鏄熸湡浜�","鏄熸湡鍏�"],
			viewData:"鏌ョ湅鏁版嵁琛ㄦ牸",
			rangeSelectorFrom:"寮€濮嬫椂闂�",
			rangeSelectorTo:"缁撴潫鏃堕棿",
			rangeSelectorZoom:"鑼冨洿",
			zoomIn:"缂╁皬",
			zoomOut:"鏀惧ぇ"
		},
		global:{
			...
			exporting:{
				...
				credits:{text:"Highcharts.com.cn",
			...
			xAxis:{
				...
				rangeSelector:{
					...
					buttons:[
						{type:"month",count:1,text:"鏈�"},
						{type:"month",count:3,text:"瀛ｅ害"},
						{type:"month",count:6,text:"鍗婂勾"},
						{type:"ytd",text:"YTD"},
						{type:"year",count:1,text:"骞�"},
						{type:"all",text:"鎵€鏈�"}
					]
				},
				plotOptions:{
					...
					ohlc:{
						tooltip:{
							split:false,
							pointFormat:'<span style="color:{point.color}">鈼�</span> <b> {series.name}</b><br/>'+"寮€鐩橈細{point.open}<br/>"+"鏈€楂橈細{point.high}<br/>"+"鏈€浣庯細{point.low}<br/>"+"鏀剁洏锛歿point.close}<br/>"
						}
					},
					candlestick:{
						tooltip:{
